...
When project will become bigger, we will start to use code spliting(dynamic components), maybe also code splitting based on routing(webpack provide nice features for this)
