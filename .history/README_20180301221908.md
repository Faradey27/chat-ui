...
For this app i decided to stop on css in js, as compromise solution between performance, native css features and developer expiarence.
There are tonn of libs for this - i choosen emotion, tiny size and good performance.
