...
For state management we will use Redux + clever/dump components approach.
...
As we do not have will use just sockets for communication we do not need to worry about async actions currently.
